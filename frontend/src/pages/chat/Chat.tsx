                    ...
                    <div className={styles.chatContainer}>
                        {!lastQuestionRef.current ? (
                            <div className={styles.chatEmptyState}>
                                ...
                                <SparkleFilled fontSize={"120px"} primaryFill={"rgba(15, 82, 186, 1)"} aria-hidden="true" aria-label="Chat logo" />
                                <h1 className={styles.chatEmptyStateTitle}>Ask a question about quantum physics</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Ask anything or try an example</h2>
                                <h3 className={styles.chatEmptyStateDisclaimer}><strong><u>Note:</u></strong> QASA is in beta and we're improving constantly. Your feedback is valuable and helps enhance the experience. Chat sessions are recorded for development purposes.</h3>
                        ...
                        <div className={styles.chatInput}>
                            <a 
                                href="https://docs.google.com/forms/d/e/1FAIpQLSc2zx0zxQ70-9AGupanZuQwb4XLweJHl2JCDzYrr57Q4_gxTQ/viewform?usp=sf_link" 
                                target="_blank" 
